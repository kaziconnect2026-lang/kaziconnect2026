      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-50 glass border-b border-border/40">
        <div className="flex items-center justify-between px-4 h-16">
          <div className="flex items-center gap-2">
            <KaziLogo size="sm" label="Pro Dashboard" />
          </div>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40 bg-background pt-16">
          <nav className="p-4 space-y-2">
            ...
            <Link to="/wallet" className="flex items-center gap-3 p-3 rounded-xl hover:bg-muted">
              <Wallet className="w-5 h-5" />
              <span>Wallet</span>
            </Link>
            <Link to="/notifications" className="flex items-center gap-3 p-3 rounded-xl hover:bg-muted">
      ...
      <div className="flex">
        ...
        <aside className="hidden lg:flex flex-col w-64 min-h-screen bg-card border-r border-border p-6">
          <div className="flex items-center gap-2 mb-8">
            <KaziLogo size="md" subtitle="Pro Dashboard" />
          </div>
